...
function LCG(s) {
    return function() {
        ...
        // 48271 = multiplier
        // imul = 32-bit integer multiplication of a and b
        return (s & 2147483647) / 2147483648;
    }
}

function shuffle(array, seed) {
    // converting strings into a numeric format 
...
function setSearchParams(seed){
    ...
    // update URL without reloding it
}
...
function init(){
    ...
    // update the URL with the current value
    setSearchParams(seedElement.value);
